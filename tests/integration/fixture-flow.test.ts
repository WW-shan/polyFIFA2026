...
describe("fixture paper flow", () => {
  test("identifies Spain -3.5 and fills a paper trade at 0.97", async () => {
    ...
    const orderbook = await readJson<OrderbookSnapshot>("tests/fixtures/orderbooks/spain-3p5-ask-097.json");
